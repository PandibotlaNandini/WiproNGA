...
namespace AgentProject.Dao
{
    public class AgentDaoImpl : IAgentDao
    {
        ...
        {
            FileStream fs = new FileStream(@"C:\Users\nandi\OneDrive\WiproTraining\Day6\ProjectOne\Agent.txt", FileMode.Open, FileAccess.Read);
        ...
        {
            FileStream fs = new FileStream(@"C:\Users\nandi\OneDrive\WiproTraining\Day6\ProjectOne\Agent.txt", FileMode.Create, FileAccess.Write);
            BinaryFormatter formatter = new BinaryFormatter();
